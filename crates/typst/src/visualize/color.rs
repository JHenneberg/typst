...
impl Color {
    ...
    // x11 color names
    pub const X11_ALICE_BLUE: Self = Self::Rgb(Rgb::new(0.94, 0.972, 1.0, 1.0));
    pub const X11_ANTIQUE_WHITE: Self = Self::Rgb(Rgb::new(0.98, 0.92, 0.844, 1.0));
    pub const X11_AQUA: Self = Self::Rgb(Rgb::new(0.0, 1.0, 1.0, 1.0));
    pub const X11_AQUAMARINE: Self = Self::Rgb(Rgb::new(0.498, 1.0, 0.83, 1.0));
    pub const X11_AZURE: Self = Self::Rgb(Rgb::new(0.94, 1.0, 1.0, 1.0));
    pub const X11_BEIGE: Self = Self::Rgb(Rgb::new(0.96, 0.96, 0.864, 1.0));
    pub const X11_BISQUE: Self = Self::Rgb(Rgb::new(1.0, 0.894, 0.77, 1.0));
    pub const X11_BLACK: Self = Self::Rgb(Rgb::new(0.0, 0.0, 0.0, 1.0));
    pub const X11_BLANCHED_ALMOND: Self = Self::Rgb(Rgb::new(1.0, 0.92, 0.804, 1.0));
    pub const X11_BLUE: Self = Self::Rgb(Rgb::new(0.0, 0.0, 1.0, 1.0));
    pub const X11_BLUE_VIOLET: Self = Self::Rgb(Rgb::new(0.54, 0.17, 0.888, 1.0));
    pub const X11_BROWN: Self = Self::Rgb(Rgb::new(0.648, 0.165, 0.165, 1.0));
    pub const X11_BURLY_WOOD: Self = Self::Rgb(Rgb::new(0.87, 0.72, 0.53, 1.0));
    pub const X11_CADET_BLUE: Self = Self::Rgb(Rgb::new(0.372, 0.62, 0.628, 1.0));
    pub const X11_CHARTREUSE: Self = Self::Rgb(Rgb::new(0.498, 1.0, 0.0, 1.0));
    pub const X11_CHOCOLATE: Self = Self::Rgb(Rgb::new(0.824, 0.41, 0.116, 1.0));
    pub const X11_CORAL: Self = Self::Rgb(Rgb::new(1.0, 0.498, 0.312, 1.0));
    pub const X11_CORNFLOWER_BLUE: Self = Self::Rgb(Rgb::new(0.392, 0.585, 0.93, 1.0));
    pub const X11_CORNSILK: Self = Self::Rgb(Rgb::new(1.0, 0.972, 0.864, 1.0));
    pub const X11_CRIMSON: Self = Self::Rgb(Rgb::new(0.864, 0.08, 0.235, 1.0));
    pub const X11_CYAN: Self = Self::Rgb(Rgb::new(0.0, 1.0, 1.0, 1.0));
    pub const X11_DARK_BLUE: Self = Self::Rgb(Rgb::new(0.0, 0.0, 0.545, 1.0));
    pub const X11_DARK_CYAN: Self = Self::Rgb(Rgb::new(0.0, 0.545, 0.545, 1.0));
    pub const X11_DARK_GOLDENROD: Self = Self::Rgb(Rgb::new(0.72, 0.525, 0.044, 1.0));
    pub const X11_DARK_GRAY: Self = Self::Rgb(Rgb::new(0.664, 0.664, 0.664, 1.0));
    pub const X11_DARK_GREEN: Self = Self::Rgb(Rgb::new(0.0, 0.392, 0.0, 1.0));
    pub const X11_DARK_GREY: Self = Self::Rgb(Rgb::new(0.664, 0.664, 0.664, 1.0));
    pub const X11_DARK_KHAKI: Self = Self::Rgb(Rgb::new(0.74, 0.716, 0.42, 1.0));
    pub const X11_DARK_MAGENTA: Self = Self::Rgb(Rgb::new(0.545, 0.0, 0.545, 1.0));
    pub const X11_DARK_OLIVE_GREEN: Self = Self::Rgb(Rgb::new(0.332, 0.42, 0.185, 1.0));
    pub const X11_DARK_ORANGE: Self = Self::Rgb(Rgb::new(1.0, 0.55, 0.0, 1.0));
    pub const X11_DARK_ORCHID: Self = Self::Rgb(Rgb::new(0.6, 0.196, 0.8, 1.0));
    pub const X11_DARK_RED: Self = Self::Rgb(Rgb::new(0.545, 0.0, 0.0, 1.0));
    pub const X11_DARK_SALMON: Self = Self::Rgb(Rgb::new(0.912, 0.59, 0.48, 1.0));
    pub const X11_DARK_SEA_GREEN: Self = Self::Rgb(Rgb::new(0.56, 0.736, 0.56, 1.0));
    pub const X11_DARK_SLATE_BLUE: Self = Self::Rgb(Rgb::new(0.284, 0.24, 0.545, 1.0));
    pub const X11_DARK_SLATE_GRAY: Self = Self::Rgb(Rgb::new(0.185, 0.31, 0.31, 1.0));
    pub const X11_DARK_SLATE_GREY: Self = Self::Rgb(Rgb::new(0.185, 0.31, 0.31, 1.0));
    pub const X11_DARK_TURQUOISE: Self = Self::Rgb(Rgb::new(0.0, 0.808, 0.82, 1.0));
    pub const X11_DARK_VIOLET: Self = Self::Rgb(Rgb::new(0.58, 0.0, 0.828, 1.0));
    pub const X11_DEEP_PINK: Self = Self::Rgb(Rgb::new(1.0, 0.08, 0.576, 1.0));
    pub const X11_DEEP_SKY_BLUE: Self = Self::Rgb(Rgb::new(0.0, 0.75, 1.0, 1.0));
    pub const X11_DIM_GRAY: Self = Self::Rgb(Rgb::new(0.41, 0.41, 0.41, 1.0));
    pub const X11_DIM_GREY: Self = Self::Rgb(Rgb::new(0.41, 0.41, 0.41, 1.0));
    pub const X11_DODGER_BLUE: Self = Self::Rgb(Rgb::new(0.116, 0.565, 1.0, 1.0));
    pub const X11_FIRE_BRICK: Self = Self::Rgb(Rgb::new(0.698, 0.132, 0.132, 1.0));
    pub const X11_FLORAL_WHITE: Self = Self::Rgb(Rgb::new(1.0, 0.98, 0.94, 1.0));
    pub const X11_FOREST_GREEN: Self = Self::Rgb(Rgb::new(0.132, 0.545, 0.132, 1.0));
    pub const X11_FUCHSIA: Self = Self::Rgb(Rgb::new(1.0, 0.0, 1.0, 1.0));
    pub const X11_GAINSBORO: Self = Self::Rgb(Rgb::new(0.864, 0.864, 0.864, 1.0));
    pub const X11_GHOST_WHITE: Self = Self::Rgb(Rgb::new(0.972, 0.972, 1.0, 1.0));
    pub const X11_GOLD: Self = Self::Rgb(Rgb::new(1.0, 0.844, 0.0, 1.0));
    pub const X11_GOLDENROD: Self = Self::Rgb(Rgb::new(0.855, 0.648, 0.125, 1.0));
    pub const X11_GRAY: Self = Self::Rgb(Rgb::new(0.5, 0.5, 0.5, 1.0));
    pub const X11_GREEN: Self = Self::Rgb(Rgb::new(0.0, 0.5, 0.0, 1.0));
    pub const X11_GREEN_YELLOW: Self = Self::Rgb(Rgb::new(0.68, 1.0, 0.185, 1.0));
    pub const X11_GREY: Self = Self::Rgb(Rgb::new(0.5, 0.5, 0.5, 1.0));
    pub const X11_HONEYDEW: Self = Self::Rgb(Rgb::new(0.94, 1.0, 0.94, 1.0));
    pub const X11_HOT_PINK: Self = Self::Rgb(Rgb::new(1.0, 0.41, 0.705, 1.0));
    pub const X11_INDIAN_RED: Self = Self::Rgb(Rgb::new(0.804, 0.36, 0.36, 1.0));
    pub const X11_INDIGO: Self = Self::Rgb(Rgb::new(0.294, 0.0, 0.51, 1.0));
    pub const X11_IVORY: Self = Self::Rgb(Rgb::new(1.0, 1.0, 0.94, 1.0));
    pub const X11_KHAKI: Self = Self::Rgb(Rgb::new(0.94, 0.9, 0.55, 1.0));
    pub const X11_LAVENDER: Self = Self::Rgb(Rgb::new(0.9, 0.9, 0.98, 1.0));
    pub const X11_LAVENDER_BLUSH: Self = Self::Rgb(Rgb::new(1.0, 0.94, 0.96, 1.0));
    pub const X11_LAWN_GREEN: Self = Self::Rgb(Rgb::new(0.488, 0.99, 0.0, 1.0));
    pub const X11_LEMON_CHIFFON: Self = Self::Rgb(Rgb::new(1.0, 0.98, 0.804, 1.0));
    pub const X11_LIGHT_BLUE: Self = Self::Rgb(Rgb::new(0.68, 0.848, 0.9, 1.0));
    pub const X11_LIGHT_CORAL: Self = Self::Rgb(Rgb::new(0.94, 0.5, 0.5, 1.0));
    pub const X11_LIGHT_CYAN: Self = Self::Rgb(Rgb::new(0.88, 1.0, 1.0, 1.0));
    pub const X11_LIGHT_GOLDENROD: Self = Self::Rgb(Rgb::new(0.933, 0.867, 0.51, 1.0));
    pub const X11_LIGHT_GOLDENROD_YELLOW: Self =
        Self::Rgb(Rgb::new(0.98, 0.98, 0.824, 1.0));
    pub const X11_LIGHT_GRAY: Self = Self::Rgb(Rgb::new(0.828, 0.828, 0.828, 1.0));
    pub const X11_LIGHT_GREEN: Self = Self::Rgb(Rgb::new(0.565, 0.932, 0.565, 1.0));
    pub const X11_LIGHT_GREY: Self = Self::Rgb(Rgb::new(0.828, 0.828, 0.828, 1.0));
    pub const X11_LIGHT_PINK: Self = Self::Rgb(Rgb::new(1.0, 0.712, 0.756, 1.0));
    pub const X11_LIGHT_SALMON: Self = Self::Rgb(Rgb::new(1.0, 0.628, 0.48, 1.0));
    pub const X11_LIGHT_SEA_GREEN: Self = Self::Rgb(Rgb::new(0.125, 0.698, 0.668, 1.0));
    pub const X11_LIGHT_SKY_BLUE: Self = Self::Rgb(Rgb::new(0.53, 0.808, 0.98, 1.0));
    pub const X11_LIGHT_SLATE_BLUE: Self = Self::Rgb(Rgb::new(0.518, 0.44, 1.0, 1.0));
    pub const X11_LIGHT_SLATE_GRAY: Self = Self::Rgb(Rgb::new(0.468, 0.532, 0.6, 1.0));
    pub const X11_LIGHT_SLATE_GREY: Self = Self::Rgb(Rgb::new(0.468, 0.532, 0.6, 1.0));
    pub const X11_LIGHT_STEEL_BLUE: Self = Self::Rgb(Rgb::new(0.69, 0.77, 0.87, 1.0));
    pub const X11_LIGHT_YELLOW: Self = Self::Rgb(Rgb::new(1.0, 1.0, 0.88, 1.0));
    pub const X11_LIME: Self = Self::Rgb(Rgb::new(0.0, 1.0, 0.0, 1.0));
    pub const X11_LIME_GREEN: Self = Self::Rgb(Rgb::new(0.196, 0.804, 0.196, 1.0));
    pub const X11_LINEN: Self = Self::Rgb(Rgb::new(0.98, 0.94, 0.9, 1.0));
    pub const X11_MAGENTA: Self = Self::Rgb(Rgb::new(1.0, 0.0, 1.0, 1.0));
    pub const X11_MAROON: Self = Self::Rgb(Rgb::new(0.5, 0.0, 0.0, 1.0));
    pub const X11_MEDIUM_AQUAMARINE: Self = Self::Rgb(Rgb::new(0.4, 0.804, 0.668, 1.0));
    pub const X11_MEDIUM_BLUE: Self = Self::Rgb(Rgb::new(0.0, 0.0, 0.804, 1.0));
    pub const X11_MEDIUM_ORCHID: Self = Self::Rgb(Rgb::new(0.73, 0.332, 0.828, 1.0));
    pub const X11_MEDIUM_PURPLE: Self = Self::Rgb(Rgb::new(0.576, 0.44, 0.86, 1.0));
    pub const X11_MEDIUM_SEA_GREEN: Self = Self::Rgb(Rgb::new(0.235, 0.7, 0.444, 1.0));
    pub const X11_MEDIUM_SLATE_BLUE: Self = Self::Rgb(Rgb::new(0.484, 0.408, 0.932, 1.0));
    pub const X11_MEDIUM_SPRING_GREEN: Self = Self::Rgb(Rgb::new(0.0, 0.98, 0.604, 1.0));
    pub const X11_MEDIUM_TURQUOISE: Self = Self::Rgb(Rgb::new(0.284, 0.82, 0.8, 1.0));
    pub const X11_MEDIUM_VIOLET_RED: Self = Self::Rgb(Rgb::new(0.78, 0.084, 0.52, 1.0));
    pub const X11_MIDNIGHT_BLUE: Self = Self::Rgb(Rgb::new(0.098, 0.098, 0.44, 1.0));
    pub const X11_MINT_CREAM: Self = Self::Rgb(Rgb::new(0.96, 1.0, 0.98, 1.0));
    pub const X11_MISTY_ROSE: Self = Self::Rgb(Rgb::new(1.0, 0.894, 0.884, 1.0));
    pub const X11_MOCCASIN: Self = Self::Rgb(Rgb::new(1.0, 0.894, 0.71, 1.0));
    pub const X11_NAVAJO_WHITE: Self = Self::Rgb(Rgb::new(1.0, 0.87, 0.68, 1.0));
    pub const X11_NAVY: Self = Self::Rgb(Rgb::new(0.0, 0.0, 0.5, 1.0));
    pub const X11_NAVY_BLUE: Self = Self::Rgb(Rgb::new(0.0, 0.0, 0.5, 1.0));
    pub const X11_OLD_LACE: Self = Self::Rgb(Rgb::new(0.992, 0.96, 0.9, 1.0));
    pub const X11_OLIVE: Self = Self::Rgb(Rgb::new(0.5, 0.5, 0.0, 1.0));
    pub const X11_OLIVE_DRAB: Self = Self::Rgb(Rgb::new(0.42, 0.556, 0.136, 1.0));
    pub const X11_ORANGE: Self = Self::Rgb(Rgb::new(1.0, 0.648, 0.0, 1.0));
    pub const X11_ORANGE_RED: Self = Self::Rgb(Rgb::new(1.0, 0.27, 0.0, 1.0));
    pub const X11_ORCHID: Self = Self::Rgb(Rgb::new(0.855, 0.44, 0.84, 1.0));
    pub const X11_PALE_GOLDENROD: Self = Self::Rgb(Rgb::new(0.932, 0.91, 0.668, 1.0));
    pub const X11_PALE_GREEN: Self = Self::Rgb(Rgb::new(0.596, 0.985, 0.596, 1.0));
    pub const X11_PALE_TURQUOISE: Self = Self::Rgb(Rgb::new(0.688, 0.932, 0.932, 1.0));
    pub const X11_PALE_VIOLET_RED: Self = Self::Rgb(Rgb::new(0.86, 0.44, 0.576, 1.0));
    pub const X11_PAPAYA_WHIP: Self = Self::Rgb(Rgb::new(1.0, 0.936, 0.835, 1.0));
    pub const X11_PEACH_PUFF: Self = Self::Rgb(Rgb::new(1.0, 0.855, 0.725, 1.0));
    pub const X11_PERU: Self = Self::Rgb(Rgb::new(0.804, 0.52, 0.248, 1.0));
    pub const X11_PINK: Self = Self::Rgb(Rgb::new(1.0, 0.752, 0.796, 1.0));
    pub const X11_PLUM: Self = Self::Rgb(Rgb::new(0.868, 0.628, 0.868, 1.0));
    pub const X11_POWDER_BLUE: Self = Self::Rgb(Rgb::new(0.69, 0.88, 0.9, 1.0));
    pub const X11_PURPLE: Self = Self::Rgb(Rgb::new(0.5, 0.0, 0.5, 1.0));
    pub const X11_RED: Self = Self::Rgb(Rgb::new(1.0, 0.0, 0.0, 1.0));
    pub const X11_ROSY_BROWN: Self = Self::Rgb(Rgb::new(0.736, 0.56, 0.56, 1.0));
    pub const X11_ROYAL_BLUE: Self = Self::Rgb(Rgb::new(0.255, 0.41, 0.884, 1.0));
    pub const X11_SADDLE_BROWN: Self = Self::Rgb(Rgb::new(0.545, 0.27, 0.075, 1.0));
    pub const X11_SALMON: Self = Self::Rgb(Rgb::new(0.98, 0.5, 0.448, 1.0));
    pub const X11_SANDY_BROWN: Self = Self::Rgb(Rgb::new(0.956, 0.644, 0.376, 1.0));
    pub const X11_SEA_GREEN: Self = Self::Rgb(Rgb::new(0.18, 0.545, 0.34, 1.0));
    pub const X11_SEASHELL: Self = Self::Rgb(Rgb::new(1.0, 0.96, 0.932, 1.0));
    pub const X11_SIENNA: Self = Self::Rgb(Rgb::new(0.628, 0.32, 0.176, 1.0));
    pub const X11_SILVER: Self = Self::Rgb(Rgb::new(0.752, 0.752, 0.752, 1.0));
    pub const X11_SKY_BLUE: Self = Self::Rgb(Rgb::new(0.53, 0.808, 0.92, 1.0));
    pub const X11_SLATE_BLUE: Self = Self::Rgb(Rgb::new(0.415, 0.352, 0.804, 1.0));
    pub const X11_SLATE_GRAY: Self = Self::Rgb(Rgb::new(0.44, 0.5, 0.565, 1.0));
    pub const X11_SLATE_GREY: Self = Self::Rgb(Rgb::new(0.44, 0.5, 0.565, 1.0));
    pub const X11_SNOW: Self = Self::Rgb(Rgb::new(1.0, 0.98, 0.98, 1.0));
    pub const X11_SPRING_GREEN: Self = Self::Rgb(Rgb::new(0.0, 1.0, 0.498, 1.0));
    pub const X11_STEEL_BLUE: Self = Self::Rgb(Rgb::new(0.275, 0.51, 0.705, 1.0));
    pub const X11_TAN: Self = Self::Rgb(Rgb::new(0.824, 0.705, 0.55, 1.0));
    pub const X11_TEAL: Self = Self::Rgb(Rgb::new(0.0, 0.5, 0.5, 1.0));
    pub const X11_THISTLE: Self = Self::Rgb(Rgb::new(0.848, 0.75, 0.848, 1.0));
    pub const X11_TOMATO: Self = Self::Rgb(Rgb::new(1.0, 0.39, 0.28, 1.0));
    pub const X11_TURQUOISE: Self = Self::Rgb(Rgb::new(0.25, 0.88, 0.815, 1.0));
    pub const X11_VIOLET: Self = Self::Rgb(Rgb::new(0.932, 0.51, 0.932, 1.0));
    pub const X11_VIOLET_RED: Self = Self::Rgb(Rgb::new(0.816, 0.125, 0.565, 1.0));
    pub const X11_WHEAT: Self = Self::Rgb(Rgb::new(0.96, 0.87, 0.7, 1.0));
    pub const X11_WHITE: Self = Self::Rgb(Rgb::new(1.0, 1.0, 1.0, 1.0));
    pub const X11_WHITE_SMOKE: Self = Self::Rgb(Rgb::new(0.96, 0.96, 0.96, 1.0));
    pub const X11_YELLOW: Self = Self::Rgb(Rgb::new(1.0, 1.0, 0.0, 1.0));
    pub const X11_YELLOW_GREEN: Self = Self::Rgb(Rgb::new(0.604, 0.804, 0.1, 1.0));
